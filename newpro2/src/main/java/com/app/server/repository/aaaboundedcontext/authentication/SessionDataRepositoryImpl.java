...
import com.app.shared.aaaboundedcontext.authentication.SessionData;
...
public class SessionDataRepositoryImpl extends SearchInterfaceImpl implements SessionDataRepository<SessionData> {
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            com.app.shared.aaaboundedcontext.authentication.SessionData s = emanager.find(com.app.shared.aaaboundedcontext.authentication.SessionData.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
