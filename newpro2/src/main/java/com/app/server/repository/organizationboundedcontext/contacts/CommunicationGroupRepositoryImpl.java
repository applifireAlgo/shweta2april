...
public class CommunicationGroupRepositoryImpl extends SearchInterfaceImpl implements CommunicationGroupRepository<CommunicationGroup> {
    ...
    public List<CommunicationGroup> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<com.app.shared.organizationboundedcontext.contacts.CommunicationGroup> query = emanager.createQuery("select u from CommunicationGroup u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<CommunicationGroup> save(List<CommunicationGroup> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                com.app.shared.organizationboundedcontext.contacts.CommunicationGroup obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            com.app.shared.organizationboundedcontext.contacts.CommunicationGroup s = emanager.find(com.app.shared.organizationboundedcontext.contacts.CommunicationGroup.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public CommunicationGroup findById(String commGroupId) throws Exception, SpartanPersistenceException {
        try {
            ...
            com.app.shared.organizationboundedcontext.contacts.CommunicationGroup listOfCommunicationGroup = (com.app.shared.organizationboundedcontext.contacts.CommunicationGroup) query.getSingleResult();
