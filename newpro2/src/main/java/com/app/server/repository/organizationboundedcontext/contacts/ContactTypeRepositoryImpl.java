...
public class ContactTypeRepositoryImpl extends SearchInterfaceImpl implements ContactTypeRepository<ContactType> {
    ...
    public List<ContactType> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<com.app.shared.organizationboundedcontext.contacts.ContactType> query = emanager.createQuery("select u from ContactType u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<ContactType> save(List<ContactType> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                com.app.shared.organizationboundedcontext.contacts.ContactType obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            com.app.shared.organizationboundedcontext.contacts.ContactType s = emanager.find(com.app.shared.organizationboundedcontext.contacts.ContactType.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public ContactType findById(String contactTypeId) throws Exception, SpartanPersistenceException {
        try {
            ...
            com.app.shared.organizationboundedcontext.contacts.ContactType listOfContactType = (com.app.shared.organizationboundedcontext.contacts.ContactType) query.getSingleResult();
