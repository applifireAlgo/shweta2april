...
public class CoreContactsRepositoryImpl extends SearchInterfaceImpl implements CoreContactsRepository<CoreContacts> {
    ...
    public List<CoreContacts> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<com.app.shared.organizationboundedcontext.contacts.CoreContacts> query = emanager.createQuery("select u from CoreContacts u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public CoreContacts save(CoreContacts entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            java.util.List<com.app.shared.organizationboundedcontext.contacts.CommunicationData> communicationdata = new java.util.ArrayList<com.app.shared.organizationboundedcontext.contacts.CommunicationData>();
            for (java.util.Iterator iterator = entity.getCommunicationData().iterator(); iterator.hasNext(); ) {
                com.app.shared.organizationboundedcontext.contacts.CommunicationData childEntity = (com.app.shared.organizationboundedcontext.contacts.CommunicationData) iterator.next();
                if (childEntity.getPrimaryKey() != null) {
                    com.app.shared.organizationboundedcontext.contacts.CommunicationData ans = emanager.find(CommunicationData.class, childEntity.getPrimaryKey());
                    communicationdata.add(ans);
                } else {
                    communicationdata.add(childEntity);
                }
            }
            java.util.List<com.app.shared.organizationboundedcontext.location.Address> address = new java.util.ArrayList<com.app.shared.organizationboundedcontext.location.Address>();
            for (java.util.Iterator iterator = entity.getAddress().iterator(); iterator.hasNext(); ) {
                com.app.shared.organizationboundedcontext.location.Address childEntity = (com.app.shared.organizationboundedcontext.location.Address) iterator.next();
                if (childEntity.getPrimaryKey() != null) {
                    com.app.shared.organizationboundedcontext.location.Address ans = emanager.find(Address.class, childEntity.getPrimaryKey());
                    address.add(ans);
                } else {
    ...
    public List<CoreContacts> save(List<CoreContacts> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                com.app.shared.organizationboundedcontext.contacts.CoreContacts obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            com.app.shared.organizationboundedcontext.contacts.CoreContacts s = emanager.find(com.app.shared.organizationboundedcontext.contacts.CoreContacts.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public void deleteCommunicationData(List<CommunicationData> communicationdata) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (com.app.shared.organizationboundedcontext.contacts.CommunicationData _communicationdata : communicationdata) {
                com.app.shared.organizationboundedcontext.contacts.CommunicationData s = emanager.find(com.app.shared.organizationboundedcontext.contacts.CommunicationData.class, _communicationdata.getCommDataId());
                emanager.remove(s);
            }
        } catch (javax.persistence.PersistenceException e) {
            throw new SpartanPersistenceException("Error in deleting entity", e);
    ...
    public void deleteAddress(List<Address> address) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (com.app.shared.organizationboundedcontext.location.Address _address : address) {
                com.app.shared.organizationboundedcontext.location.Address s = emanager.find(com.app.shared.organizationboundedcontext.location.Address.class, _address.getAddressId());
                emanager.remove(s);
            }
        } catch (javax.persistence.PersistenceException e) {
            throw new SpartanPersistenceException("Error in deleting entity", e);
    ...
    public List<CoreContacts> findByTitleId(String titleId) throws Exception, SpartanPersistenceException {
        try {
            ...
            java.util.List<com.app.shared.organizationboundedcontext.contacts.CoreContacts> listOfCoreContacts = query.getResultList();
    ...
    public CoreContacts findById(String contactId) throws Exception, SpartanPersistenceException {
        try {
            ...
            com.app.shared.organizationboundedcontext.contacts.CoreContacts listOfCoreContacts = (com.app.shared.organizationboundedcontext.contacts.CoreContacts) query.getSingleResult();
            return listOfCoreContacts;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
