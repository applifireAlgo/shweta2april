...
public class AppMenusRepositoryImpl extends SearchInterfaceImpl implements AppMenusRepository<AppMenus> {
    ...
    public List<AppMenus> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<com.app.shared.aaaboundedcontext.authorization.AppMenus> query = emanager.createQuery("select u from AppMenus u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<AppMenus> save(List<AppMenus> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                com.app.shared.aaaboundedcontext.authorization.AppMenus obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            com.app.shared.aaaboundedcontext.authorization.AppMenus s = emanager.find(com.app.shared.aaaboundedcontext.authorization.AppMenus.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public AppMenus findById(String menuId) throws Exception, SpartanPersistenceException {
        try {
            ...
            com.app.shared.aaaboundedcontext.authorization.AppMenus listOfAppMenus = (com.app.shared.aaaboundedcontext.authorization.AppMenus) query.getSingleResult();
