...
public class AddressTypeRepositoryImpl extends SearchInterfaceImpl implements AddressTypeRepository<AddressType> {
    ...
    public List<AddressType> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<com.app.shared.organizationboundedcontext.location.AddressType> query = emanager.createQuery("select u from AddressType u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<AddressType> save(List<AddressType> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                com.app.shared.organizationboundedcontext.location.AddressType obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            com.app.shared.organizationboundedcontext.location.AddressType s = emanager.find(com.app.shared.organizationboundedcontext.location.AddressType.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public AddressType findById(String addressTypeId) throws Exception, SpartanPersistenceException {
        try {
            ...
            com.app.shared.organizationboundedcontext.location.AddressType listOfAddressType = (com.app.shared.organizationboundedcontext.location.AddressType) query.getSingleResult();
