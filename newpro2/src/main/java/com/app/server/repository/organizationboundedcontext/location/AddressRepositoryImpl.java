...
public class AddressRepositoryImpl extends SearchInterfaceImpl implements AddressRepository<Address> {
    ...
    public List<Address> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<com.app.shared.organizationboundedcontext.location.Address> query = emanager.createQuery("select u from Address u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<Address> save(List<Address> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                com.app.shared.organizationboundedcontext.location.Address obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            com.app.shared.organizationboundedcontext.location.Address s = emanager.find(com.app.shared.organizationboundedcontext.location.Address.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public List<Address> findByAddressTypeId(String addressTypeId) throws Exception, SpartanPersistenceException {
        try {
            ...
            java.util.List<com.app.shared.organizationboundedcontext.location.Address> listOfAddress = query.getResultList();
    ...
    public Address findById(String addressId) throws Exception, SpartanPersistenceException {
        try {
            ...
            com.app.shared.organizationboundedcontext.location.Address listOfAddress = (com.app.shared.organizationboundedcontext.location.Address) query.getSingleResult();
            return listOfAddress;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
