package com.app.server.repository.aaaboundedcontext.authorization;
...
public class RolesRepositoryImpl extends SearchInterfaceImpl implements RolesRepository<Roles> {
    ...
    public List<Roles> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<com.app.shared.aaaboundedcontext.authorization.Roles> query = emanager.createQuery("select u from Roles u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<Roles> save(List<Roles> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                com.app.shared.aaaboundedcontext.authorization.Roles obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            com.app.shared.aaaboundedcontext.authorization.Roles s = emanager.find(com.app.shared.aaaboundedcontext.authorization.Roles.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public void deleteRoleMenuBridge(List<RoleMenuBridge> rolemenubridge) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (com.app.shared.aaaboundedcontext.authorization.RoleMenuBridge _rolemenubridge : rolemenubridge) {
                com.app.shared.aaaboundedcontext.authorization.RoleMenuBridge s = emanager.find(com.app.shared.aaaboundedcontext.authorization.RoleMenuBridge.class, _rolemenubridge.getRoleMenuMapId());
                emanager.remove(s);
            }
        } catch (javax.persistence.PersistenceException e) {
            throw new SpartanPersistenceException("Error in deleting entity", e);
    ...
    public Roles findById(String roleId) throws Exception, SpartanPersistenceException {
        try {
            ...
            com.app.shared.aaaboundedcontext.authorization.Roles listOfRoles = (com.app.shared.aaaboundedcontext.authorization.Roles) query.getSingleResult();
            return listOfRoles;
        } catch (javax.persistence.PersistenceException e) {
