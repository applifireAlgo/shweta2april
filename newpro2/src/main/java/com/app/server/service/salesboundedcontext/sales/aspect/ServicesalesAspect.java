...
public class ServicesalesAspect extends ServiceAspect {
    ...
    @Pointcut("execution(* com.app.server.service.salesboundedcontext.sales..get*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
    protected void getOperation() {
    }

    @Pointcut("execution(* com.app.server.service.salesboundedcontext.sales..*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
