package com.app.shared.aaaboundedcontext.authorization;
...
@SourceCodeAuthorClass(createdBy = "shweta.zagade1209@gmail.com", updatedBy = "shweta.zagade1209@gmail.com", versionNumber = "3", comments = "RoleMenuBridge", complexity = Complexity.LOW)
...
public class RoleMenuBridge implements Serializable, CommonEntityInterface, Comparator<RoleMenuBridge> {
    ...
    public boolean equals(Object obj) {
        try {
            com.app.shared.aaaboundedcontext.authorization.RoleMenuBridge other = (com.app.shared.aaaboundedcontext.authorization.RoleMenuBridge) obj;
            if (roleMenuMapId == null) {
                return false;
