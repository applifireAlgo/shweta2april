...
@SourceCodeAuthorClass(createdBy = "shweta.zagade1209@gmail.com", updatedBy = "shweta.zagade1209@gmail.com", versionNumber = "3", comments = "PassRecovery", complexity = Complexity.LOW)
...
public class PassRecovery implements Serializable, CommonEntityInterface, PassRecoveryInterface, Comparator<PassRecovery> {
    ...
    public boolean equals(Object obj) {
        try {
            com.app.shared.aaaboundedcontext.authentication.PassRecovery other = (com.app.shared.aaaboundedcontext.authentication.PassRecovery) obj;
            if (passRecoveryId == null) {
                return false;
