...
public class User implements Serializable, CommonEntityInterface, UserInterface, Comparator<User> {
    ...
    public User addPassRecovery(PassRecovery _passRecovery) {
        if (this.passRecovery == null) {
            this.passRecovery = new java.util.ArrayList<com.app.shared.aaaboundedcontext.authentication.PassRecovery>();
        }
    ...
    public boolean equals(Object obj) {
        try {
            com.app.shared.aaaboundedcontext.authentication.User other = (com.app.shared.aaaboundedcontext.authentication.User) obj;
            if (userId == null) {
                return false;
