...
public class Roles implements Serializable, CommonEntityInterface, Comparator<Roles> {
    ...
    public Roles addRoleMenuBridge(RoleMenuBridge _roleMenuBridge) {
        if (this.roleMenuBridge == null) {
            this.roleMenuBridge = new java.util.ArrayList<com.app.shared.aaaboundedcontext.authorization.RoleMenuBridge>();
        }
    ...
    public boolean equals(Object obj) {
        try {
            com.app.shared.aaaboundedcontext.authorization.Roles other = (com.app.shared.aaaboundedcontext.authorization.Roles) obj;
            if (roleId == null) {
                return false;
