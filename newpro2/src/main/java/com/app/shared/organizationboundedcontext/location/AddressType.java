package com.app.shared.organizationboundedcontext.location;
...
public class AddressType implements Serializable, CommonEntityInterface, Comparator<AddressType> {
    ...
    public boolean equals(Object obj) {
        try {
            com.app.shared.organizationboundedcontext.location.AddressType other = (com.app.shared.organizationboundedcontext.location.AddressType) obj;
            if (addressTypeId == null) {
                return false;
