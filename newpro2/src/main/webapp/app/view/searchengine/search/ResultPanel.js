Ext
		.define(
				'Newpro2.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Newpro2.view.searchengine.search.SearchEngineMainPanelController','Newpro2.view.searchengine.search.PanelHeaderField' ,'Newpro2.view.searchengine.search.ReportGridView','Newpro2.view.searchengine.search.ReportChartView','Newpro2.view.searchengine.search.documentView','Newpro2.view.searchengine.search.DouMeanView','Newpro2.view.googlemaps.map.MapPanel'],
