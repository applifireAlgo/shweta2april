Ext.define('Newpro2.view.searchengine.search.SearchEngineMainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'solrsearchmainpanel',
	

	requires : ['Newpro2.view.searchengine.search.NorthPanel', 'Newpro2.view.searchengine.search.SearchResult','Newpro2.view.searchengine.search.SearchEngineMainPanelController'],
