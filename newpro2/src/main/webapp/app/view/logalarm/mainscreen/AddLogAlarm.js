 ...
 * 
 */
Ext.define('Newpro2.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Newpro2.view.logalarm.mainscreen.AddLogAlarmController',
			'Newpro2.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Newpro2.view.logalarm.mainscreen.AppAlarmPanel',
