 ...
 * 
 */
Ext.define('Newpro2.view.logalarm.LogAlarmMainView', {
	extend : 'Ext.form.Panel',
	xtype : 'logAlarmMainView',
	requires : [ 'Newpro2.view.logalarm.LogAlarmMainViewController',
			'Newpro2.view.logalarm.tree.LogAlarmTreePanel',
			'Newpro2.view.logalarm.mainscreen.LogAlarmMainViewTabPanel',
