...
Ext
		.define(
				'Newpro2.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Newpro2.view.logger.tabs.details.DetailsTab',
							'Newpro2.view.logger.tabs.fileconnector.FileConnectorTab',
							'Newpro2.view.logger.tabs.dbconnector.DBConnectorTab',
							'Newpro2.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Newpro2.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Newpro2.view.logger.LogConfigurationTabPanelController',
