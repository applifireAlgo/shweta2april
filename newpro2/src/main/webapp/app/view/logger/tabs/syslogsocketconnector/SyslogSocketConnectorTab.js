 ...
 * 
 */
Ext.define('Newpro2.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Newpro2.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
