 ...
 * 
 */
Ext.define('Newpro2.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Newpro2.view.securityconfig.SecurityConfigController',
			'Newpro2.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
