 ...
 */
Ext.define('Newpro2.view.fw.component.DateTimeField', {
    extend: 'Ext.form.field.Date',
    alias: 'widget.customdatetimefield',
    xtype : 'customdatetimefield',
    requires: ['Newpro2.view.fw.component.DateTimePicker'
               ],
    ...
    createPicker: function() {
        ...
        return new Newpro2.view.fw.component.DateTimePicker(o);
    },
