Ext.define('Newpro2.view.fw.frameworkController.RegistrationGridViewController', {
     extend: 'Newpro2.view.fw.frameworkController.FrameworkViewController',
     ...
     onConsoleClick: function() {
          var window = Ext.create('Newpro2.view.console.ConsoleWindow');
