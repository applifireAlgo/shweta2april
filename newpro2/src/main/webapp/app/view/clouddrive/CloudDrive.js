Ext.define("Newpro2.view.clouddrive.CloudDrive", {
	extend : 'Ext.panel.Panel',
	xtype : 'clouddrive',
	requires : [ 'Newpro2.view.clouddrive.CloudDriveController',
	             'Newpro2.view.clouddrive.documentview.DocumentsView',
	             'Newpro2.view.clouddrive.drivedetails.DriveDetails',
	             //'Newpro2.view.clouddrive.documentview.DocumentListView'
	             ],
