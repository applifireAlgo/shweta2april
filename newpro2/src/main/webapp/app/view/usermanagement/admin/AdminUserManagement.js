Ext.define('Newpro2.view.usermanagement.admin.AdminUserManagement', {
	extend : 'Ext.tab.Panel',
	requires : ['Newpro2.view.usermanagement.admin.UserPasswordReset',
	            'Newpro2.view.usermanagement.admin.AddUserDetails',
	            'Newpro2.view.usermanagement.admin.ViewUser'],
