Ext.define('Newpro2.view.usermanagement.admin.UserForm', {
	extend : 'Ext.form.Panel',
	xtype : 'userForm',
	itemId : 'userForm',
	requires : [ 'Newpro2.view.usermanagement.admin.AddUserDetailsViewModel', 'Newpro2.model.AddUserDataModel' ],
