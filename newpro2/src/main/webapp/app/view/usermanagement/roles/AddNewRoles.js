Ext.define('Newpro2.view.usermanagement.roles.AddNewRoles', {
	extend : 'Ext.panel.Panel',
	requires : [ 'Newpro2.view.usermanagement.roles.AddNewRolesController', 'Ext.tree.plugin.TreeViewDragDrop' ],
