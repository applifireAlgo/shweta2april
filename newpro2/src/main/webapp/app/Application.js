 ...
 */
Ext.define('Newpro2.Application', {
	...
	requires : [ "Ext.ux.BoxReorderer", "Ext.ux.CellDragDrop",
			...
			"Ext.ProgressBarWidget", "Ext.ZIndexManager","Newpro2.view.databrowsercalendar.DBCalendar" ],
	...
	stores : [ 'Newpro2.store.QueryCriteriaWidgetsStore' ],
	...
	try {
		...
		if (responseData.response) {
			if (responseData.response.exceptionId == 4005 && !sessionTimeOutFlag) {
				...
				var loginWindow = Ext.create('Newpro2.view.login.SessionLogin').center();
