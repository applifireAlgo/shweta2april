...
public class SalesRegionTestCase extends EntityTestCriteria {
    ...
    private SalesRegion createSalesRegion(Boolean isSave) throws SpartanPersistenceException, SpartanConstraintViolationException {
        SalesRegion salesregion = new SalesRegion();
        salesregion.setRegionname("tTmT7j5RqcXTBp1tCHbpJJzbc6iuimTAWbIVENFao8fLAuKj5f");
    ...
    public void test2Update() {
        try {
            ...
            salesregion.setRegionname("xW17SsadIv8NzeJ1yAc5oBqJroH7j7KQX2MZCC46DiVtu2lOqY");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 2, "regionname", "FCjN9BX9y2D5wMdAcaQ5Kr97VIZGuT8lcyJEmxCsbQMwwgWc9cJJJPpnkK3it728n"));
